...
INSERT INTO `comment` VALUES (11, 7, '续航真的有那么大提升吗？我现在的手机一天两充', 4, NULL, NULL, NULL, NULL, 12, 3, 1, '2026-03-15 19:46:31', '2026-03-22 20:37:30');
...
INSERT INTO `comment` VALUES (38, 14, '沙发', 19, NULL, NULL, NULL, NULL, 0, 2, 1, '2026-03-22 20:17:07', '2026-03-22 20:27:32');
INSERT INTO `comment` VALUES (39, 14, '有问题', 19, 38, NULL, 19, NULL, 0, 0, 1, '2026-03-22 20:27:24', '2026-03-22 20:27:24');
INSERT INTO `comment` VALUES (40, 14, '你放屁', 19, 38, 39, 19, NULL, 0, 0, 1, '2026-03-22 20:27:33', '2026-03-22 20:27:33');
INSERT INTO `comment` VALUES (41, 7, '对的', 19, 11, NULL, 4, NULL, 0, 0, 1, '2026-03-22 20:27:53', '2026-03-22 20:27:53');
INSERT INTO `comment` VALUES (42, 7, '不对', 19, 11, NULL, 4, NULL, 0, 0, 1, '2026-03-22 20:28:06', '2026-03-22 20:28:06');
INSERT INTO `comment` VALUES (43, 7, '不对', 19, 11, 42, 19, NULL, 0, 0, 1, '2026-03-22 20:37:30', '2026-03-22 20:37:30');
INSERT INTO `comment` VALUES (44, 7, '好的好的', 19, NULL, NULL, NULL, NULL, 0, 0, 1, '2026-03-22 20:48:01', '2026-03-22 20:48:01');
...
INSERT INTO `goods` VALUES (121, '火腿肠好吃', 19, NULL, 1, '火腿肠', '[\"/uploads/2026/03/22/213adceac29e47bc8acfdb92dd50b77c.jpg\"]', 12.00, NULL, 100, NULL, 0, 0, 0, '', NULL, 0, 0, 14, 27, 0, 1, NULL, '2026-03-22 14:09:03', '2026-03-22 19:39:18', 0);
INSERT INTO `goods` VALUES (122, '油', 19, NULL, 2, '好多油', '[\"/uploads/2026/03/22/1399e448d1e94c43aa88537fef2cdbdf.jpg\", \"/uploads/2026/03/22/48da4ace14394f97b72aa863d318b7d8.jpg\"]', 80.00, NULL, 10, NULL, 0, 0, 0, '', NULL, 0, 0, 10, 2, 0, 1, NULL, '2026-03-22 16:48:01', '2026-03-22 19:39:01', 0);
...
CREATE TABLE `interaction_message`  (
  ...
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE,
  INDEX `idx_post_id`(`post_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '互动消息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `interaction_message` VALUES (4, 1, 19, 2, 14, 38, '沙发', 0, '2026-03-22 20:17:07');
INSERT INTO `interaction_message` VALUES (5, 4, 19, 3, 7, 41, '对的', 0, '2026-03-22 20:27:53');
INSERT INTO `interaction_message` VALUES (6, 4, 19, 3, 7, 42, '不对', 0, '2026-03-22 20:28:06');
INSERT INTO `interaction_message` VALUES (7, 1, 19, 2, 7, 44, '好的好的', 0, '2026-03-22 20:48:01');
...
CREATE TABLE `post`  (
  ...
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '帖子表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `post` VALUES (7, 'iPhone 15 Pro Max 使用一周感受分享', '入手一周了，钛金属边框真的很有质感，A17 Pro性能强劲，玩游戏完全不卡。5倍光学变焦拍远景很清晰。电池续航也比上一代好很多。', 1, NULL, 1, '[\"https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=800\", \"https://images.unsplash.com/photo-1510557880182-3d4d3cba35a5?w=800\"]', NULL, 2365, 356, 49, 0, 0, 1, 1, '2026-03-18 19:26:23', '2026-03-22 21:03:04');
...
INSERT INTO `post` VALUES (12, '小米14 Ultra 徕卡影像体验', '徕卡色彩真的很有味道，随手一拍就是大片。夜景表现也非常出色。', 1, NULL, 4, '[\"https://example.com/post/mi-photo1.jpg\"]', NULL, 1877, 289, 43, 0, 0, 1, 1, '2026-03-18 19:26:23', '2026-03-22 19:54:24');
...
INSERT INTO `post` VALUES (14, 'Mate 60 Pro 卫星通信实测', '今天试了卫星通信功能，虽然平时用不上，但关键时刻能救命。昆仑玻璃也很耐摔。', 1, NULL, 6, '[\"https://example.com/post/hw-sat.jpg\"]', NULL, 3462, 456, 70, 0, 0, 1, 1, '2026-03-18 19:26:23', '2026-03-22 20:27:32');
...
INSERT INTO `post` VALUES (19, '最新小道消息', '快来屯7500f吧，现在很便宜', 19, NULL, NULL, '[\"blob:http://localhost:5173/91e28263-030a-4a6e-a7b4-13b4144a78a1\", \"blob:http://localhost:5173/1651dfd3-ca1b-4417-83e3-f9835d113ef8\", \"blob:http://localhost:5173/813392d9-4e2c-4f9f-8f93-927de465103c\", \"blob:http://localhost:5173/391ebe8e-e1c6-4edc-acbe-58a02aad343b\", \"blob:http://localhost:5173/19b677bf-3e22-4cc4-9c6c-5f38ffe2622a\", \"blob:http://localhost:5173/4df1bba5-a86f-4027-98c9-857611b23906\", \"blob:http://localhost:5173/f801617d-4e1c-4c5e-996c-05eb35a3a44b\", \"blob:http://localhost:5173/c11fc746-61b3-47d9-84c9-d1fae732405f\"]', '[\"DIY\"]', 0, 0, 0, 0, 0, 0, 1, '2026-03-22 19:53:21', '2026-03-22 19:53:21');
...
-- ----------------------------
-- Table structure for post_community
-- ----------------------------
...
CREATE TABLE `post_community`  (
  ...
  `created_at` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_post_community`(`post_id` ASC, `community_id` ASC) USING BTREE,
  INDEX `idx_community_id`(`community_id` ASC) USING BTREE,
  INDEX `idx_post_id`(`post_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '帖子-社区关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of post_community
-- ----------------------------
INSERT INTO `post_community` VALUES (1, 1, 1, '2026-03-14 18:13:46');
INSERT INTO `post_community` VALUES (2, 2, 3, '2026-03-14 18:13:46');
INSERT INTO `post_community` VALUES (3, 4, 4, '2026-03-14 18:13:46');
INSERT INTO `post_community` VALUES (4, 3, 5, '2026-03-14 18:13:46');
INSERT INTO `post_community` VALUES (5, 5, 6, '2026-03-14 18:13:46');
INSERT INTO `post_community` VALUES (6, 6, 7, '2026-03-14 18:13:46');
