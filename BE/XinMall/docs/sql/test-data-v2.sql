...
(1, 'iPhone 15 Pro Max 开箱体验，钛金属质感太棒了！', '今天收到了新手机，分享一下开箱体验。包装很简洁，手机拿在手里的质感真的很好，钛金属边框摸起来很舒服。屏幕显示效果非常棒，A17 Pro芯片运行流畅，拍照效果也很出色。', 1, 1, 1, '["https://example.com/post/1-1.jpg", "https://example.com/post/1-2.jpg"]', '["开箱", "iPhone15", "体验"]', 5000, 250, 50, 100, 0, 1, 1, NOW(), NOW()),
(2, '小米14 Ultra 拍照测评，徕卡色彩真的很德味', '分享一下这款手机的拍照效果，徕卡色彩调教真的很棒，人像模式效果很好，夜景拍摄也很出色。', 2, 3, 4, '["https://example.com/post/2-1.jpg", "https://example.com/post/2-2.jpg"]', '["拍照", "徕卡", "测评"]', 3000, 150, 30, 60, 0, 0, 1, NOW(), NOW()),
(3, '二手交易注意事项，总结一些经验', '总结一些二手交易的经验，希望大家都能顺利交易，避免被骗。1. 尽量当面交易 2. 检查机器是否有锁 3. 核对序列号...', 5, 5, NULL, '[]', '["交易", "经验", "注意事项"]', 2000, 100, 40, 80, 1, 1, 1, NOW(), NOW()),
(4, '华为Mate 60 Pro 卫星通话体验', '测试了一下卫星通话功能，虽然平时用不上，但是关键时刻真的能救命。分享一下使用体验...', 4, 4, 6, '["https://example.com/post/4-1.jpg"]', '["卫星通话", "华为", "体验"]', 4000, 200, 35, 70, 0, 0, 1, NOW(), NOW()),
(5, 'MacBook Pro M3 Pro 开发体验', '作为开发者，分享一下M3 Pro MacBook的开发体验，编译速度很快，续航也很给力...', 1, 6, 8, '["https://example.com/post/5-1.jpg"]', '["MacBook", "开发", "M3"]', 2500, 120, 25, 50, 0, 0, 1, NOW(), NOW()),
(6, 'iPhone 15 Pro vs 小米14 Ultra 拍照对比', '两款手机拍照对比，各有特色，分享一下我的使用感受...', 3, 7, NULL, '["https://example.com/post/6-1.jpg", "https://example.com/post/6-2.jpg"]', '["对比", "拍照", "iPhone", "小米"]', 6000, 300, 60, 120, 0, 1, 1, NOW(), NOW());
