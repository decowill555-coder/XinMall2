    ...
    <scroll-view scroll-y class="search-scroll">
        ...
        <view class="hot-section">
          ...
          <view class="hot-list">
            ...
            >
              ...
              <ui-tag v-if="item.isHot" type="danger" size="xs">�?/ui-tag>
            </view>
          </view>
        </view>
      </view>
      ...
      <view v-else class="search-result">
        <view class="result-header">
          <text class="result-count">找到 {{ resultList.length }} 个商�?/text>
        </view>
          ...
          >
            ...
            <view class="item-info">
              ...
              <view class="item-bottom">
                ...
                <text class="item-sales">{{ item.sales }}人付�?/text>
              </view>
            </view>
          </view>
        </view>
...
const resultList = ref([
  { id: 1, cover: 'https://picsum.photos/200/200?random=801', title: 'iPhone 15 Pro Max 256GB 钛金属原�?, price: 7999, sales: 128, tags: ['99�?, '在保'] },
  { id: 2, cover: 'https://picsum.photos/200/200?random=802', title: 'iPhone 15 Pro 128GB 蓝色钛金�?, price: 6999, sales: 89, tags: ['全新', '官方'] },
  { id: 3, cover: 'https://picsum.photos/200/200?random=803', title: 'iPhone 15 Plus 256GB 粉色', price: 5999, sales: 56, tags: ['95�?, '送壳'] }
]);
