  ...
  <view class="cart-page">
    ...
    <scroll-view scroll-y class="cart-scroll">
      <view v-if="cartList.length === 0" class="empty-state">
        ...
        <text class="empty-text">购物车空空如�?/text>
        <ui-button type="primary" size="sm" @click="goShopping">去逛�?/ui-button>
      </view>
...
const cartList = ref([
  { id: 1, cover: 'https://picsum.photos/200/200?random=301', title: 'iPhone 15 Pro Max 256GB', spec: '钛金属原�?, price: 7999, quantity: 1, selected: true },
  { id: 2, cover: 'https://picsum.photos/200/200?random=302', title: 'AirPods Pro 第二�?, spec: 'USB-C', price: 1399, quantity: 2, selected: true },
  { id: 3, cover: 'https://picsum.photos/200/200?random=303', title: 'MacBook Pro 14�?, spec: 'M3芯片 16G+512G', price: 12999, quantity: 1, selected: false }
]);
