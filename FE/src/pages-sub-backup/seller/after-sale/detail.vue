  ...
  <view class="after-sale-detail-page">
    ...
    <scroll-view scroll-y class="detail-scroll">
      ...
      <view class="info-card">
        ...
        <view class="info-item">
          <text class="info-label">退款金�?/text>
...
const statusConfig = computed(() => {
  const configs: Record<string, any> = {
    pending: { icon: 'clock', color: '#FF9500', text: '待处�?, desc: '请在48小时内处�? },
    processing: { icon: 'refresh', color: '#007AFF', text: '处理�?, desc: '请等待买家退�? },
    completed: { icon: 'check-circle', color: '#34C759', text: '已完�?, desc: '售后已完�? }
  };
