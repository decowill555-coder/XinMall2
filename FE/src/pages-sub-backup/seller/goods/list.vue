...
const goodsList = ref([
  { id: 1, cover: 'https://picsum.photos/200/200?random=l1', title: 'iPhone 15 Pro Max 256GB 钛金属原�?, price: 7999, stock: 10, status: 'on', isRecommend: true },
  { id: 2, cover: 'https://picsum.photos/200/200?random=l2', title: 'MacBook Pro 14�?M3芯片', price: 12999, stock: 5, status: 'on', isRecommend: false },
  { id: 3, cover: 'https://picsum.photos/200/200?random=l3', title: 'AirPods Pro 第二�?, price: 1399, stock: 30, status: 'on', isRecommend: true },
  { id: 4, cover: 'https://picsum.photos/200/200?random=l4', title: 'iPad Pro 12.9�?M2', price: 6999, stock: 0, status: 'off', isRecommend: false }
]);
