...
const transactions = ref([
  { id: 1, type: 'income', title: '商品销售收�?, amount: 7999.00, time: '2024-01-15 10:30' },
  { id: 2, type: 'expense', title: '提现', amount: 5000.00, time: '2024-01-14 15:20' },
  { id: 3, type: 'income', title: '商品销售收�?, amount: 1399.00, time: '2024-01-13 09:15' },
  { id: 4, type: 'expense', title: '平台服务�?, amount: 50.00, time: '2024-01-12 18:00' },
  { id: 5, type: 'income', title: '商品销售收�?, amount: 2199.00, time: '2024-01-11 14:30' }
]);
...
const goBankCard = () => {
  uni.showToast({ title: '银行卡管�?, icon: 'none' });
};
