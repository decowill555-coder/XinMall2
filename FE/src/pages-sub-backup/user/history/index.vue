...
const historyList = ref([
  {
    date: '今天',
    list: [
      { id: 1, cover: 'https://picsum.photos/200/200?random=h1', title: 'iPhone 15 Pro Max 256GB 钛金属原�?, price: 7999, tags: ['99�?, '在保'], viewTime: '10:30' },
      { id: 2, cover: 'https://picsum.photos/200/200?random=h2', title: 'MacBook Pro 14�?M3芯片', price: 12999, tags: ['全新', '官方'], viewTime: '09:15' }
    ]
  },
  {
    date: '昨天',
    list: [
      { id: 3, cover: 'https://picsum.photos/200/200?random=h3', title: 'AirPods Pro 第二�?, price: 1399, tags: ['全新', '正品'], viewTime: '18:20' },
      { id: 4, cover: 'https://picsum.photos/200/200?random=h4', title: 'iPad Pro 12.9�?M2', price: 6999, tags: ['95�?, '送配�?], viewTime: '14:30' }
    ]
  },
  {
    date: '3天前',
    list: [
      { id: 5, cover: 'https://picsum.photos/200/200?random=h5', title: 'Sony WH-1000XM5 降噪耳机', price: 2199, tags: ['9成新', '箱说�?], viewTime: '20:45' }
    ]
  }
]);
...
const clearHistory = () => {
  uni.showModal({
    ...
    success: (res) => {
      if (res.confirm) {
        historyList.value = [];
        uni.showToast({ title: '已清�?, icon: 'success' });
      }
    }
  });
};
